...
The goal:  
Build a CRM module where field reps can log their interactions using:
- A structured form  
...
### 🔹 **AI Agent**
Implements **5 tools** (minimum required):

1. **Log Interaction** (mandatory)  
2. **Edit Interaction** (mandatory)  
3. **Get HCP Details**  
4. **Get Past Interactions**  
5. **Next Best Action Recommendation (NBA)** powered by LLM  
